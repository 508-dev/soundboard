...
standing release PR; merging *that* tags a version and publishes the signed APK
to GitHub Releases and our F-Droid repository, and the AAB to Play's internal
track. Commit subjects are [Conventional
Commits](https://www.conventionalcommits.org/) and decide the version.
